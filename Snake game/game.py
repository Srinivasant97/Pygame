...
#
#     def isGameOver(self):
#         if (self.snake.wormCoords[self.snake.HEAD]['x'] == 0 or
#                 self.snake.wormCoords[self.snake.HEAD]['x'] == Config.CELLWIDTH-1 or
#                 self.snake.wormCoords[self.snake.HEAD]['y'] == 0 or
#                 self.snake.wormCoords[self.snake.HEAD]['y'] == Config.CELLHEIGHT-1):
